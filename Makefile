...
UNSTABLE_FEATURES=chc,unstable-dpki,unstable-sharding,unstable-warrants,unstable-functions,unstable-countersigning,unstable-mirgation,$(DEFAULT_FEATURES)
