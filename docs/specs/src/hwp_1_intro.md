...
**Effective coordination arises from the ability to articulate appropriate ground rules, including the ability to change said rules.** Coordination cannot be effective if it does not comprehend the real-world context it is applying its efforts to. However, agents cannot fully comprehend their context at first; understanding comes with interaction over time. And as the agents interact with and within their context, they change the context, bringing new situations to comprehend. This means that any "grammar"[^grammatic] in which ground rules are written must be expressive enough to write rules that map well to the needs of the problem domain. This must necessarily also include the capacity to evolve those same rules in response to changing understanding and context. Furthermore, agents in one group naturally interact with agents in another group. This can create points of divergent and convergent evolution via experimentation and cross-pollination of understanding.
...
We begin by stating our axioms regarding the nature of coordination:
