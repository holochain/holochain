...
If any of the dependencies of the *release-automation* crate have changed, the autogenerated nix expressions need to be regenerated:

```sh
nix-shell --pure --run 'hc-regen-nix-expressions'
```
