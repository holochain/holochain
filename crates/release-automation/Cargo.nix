  ...
  internal = rec {
    ...
    crates = {
      ...
      "holochain_util" = rec {
        ...
        version = "0.0.7";
        edition = "2018";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../holochain_util; };
        authors = [
