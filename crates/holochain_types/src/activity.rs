...
impl From<AgentActivityResponse<Commit>> for holochain_zome_types::query::AgentActivity {
    fn from(a: AgentActivityResponse<Commit>) -> Self {
        let valid_activity = match a.valid_activity {
            ChainItems::Full(commits) => commits
                .into_iter()
