...
/// Overrides for P2P configuration settings.
///
/// This struct holds optional override values for P2P configurations
/// such as bootstrap URLs and signal server URLs.
#[derive(Debug, Default, Clone, PartialEq, Eq)]
pub struct P2pConfigOverrides {
...
mod tests {
    ...
    fn test_should_tell_whether_is_overriding() {
        let overrides = P2pConfigOverrides {
            bootstrap_url: None,
            signal_url: None,
        };
