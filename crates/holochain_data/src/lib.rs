...
/// This should be identical to the function `default_db_max_readers` in `holochain_conductor_api`.
///
/// It is duplicated here to avoid refactoring the crate layout.
fn default_max_readers() -> u16 {
...
impl HolochainDataConfig {
    ...
    /// Set the number of read connections in  pool
