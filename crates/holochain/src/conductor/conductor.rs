...
mod app_status_impls {
    ...
    impl Conductor {
        ...
        pub(crate) async fn create_cells_and_add_to_state(
            ...
            config_override: Option<P2pConfigOverrides>,
        ) -> ConductorResult<()> {
        ...
        async fn create_cell(
            ...
            cell_id: &CellId,
            chc: Option<ChcImpl>,
            overrides: Option<P2pConfigOverrides>,
        ...
        /// Get from [`AppManifest`] the [`P2pConfigOverrides`] to apply when creating cells for the app.
        pub(crate) fn p2p_config_overrides(manifest: &AppManifest) -> Option<P2pConfigOverrides> {
            let mut overrides = P2pConfigOverrides::default();
            match manifest {
