...
mod interface_impls {
    ...
    impl Conductor {
                ...
                async move {
                    match driver {
                        InterfaceDriver::Websocket {
                            ...
                            let listener =
                                spawn_websocket_listener(port, danger_addr, allowed_origins)
                                    .await?;
        ...
        pub async fn add_app_interface(
            ...
            let config =
                AppInterfaceConfig::websocket(port, danger_addr, allowed_origins, installed_app_id);
