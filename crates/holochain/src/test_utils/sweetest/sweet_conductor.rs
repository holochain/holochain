...
impl SweetConductorBatch {
    /// Map the given ConductorConfigs into SweetConductors, each with its own new TestEnvs
    ...
    /// Create the given number of new SweetConductors, each with its own new TestEnvs
