...
pub async fn disintegrate_single_metadata<C: MetadataBufT, P: PrefixType>(
    ...
    match op {
        ...
        DhtOpLight::StoreEntry(hash, _, _) => {
            ...
            meta_store.deregister_header(new_entry_header).await?;
        }
