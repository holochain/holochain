...
//! #### Validation checks
//!
//! The workflow operations on [`DhtOp`]s which can be either a [`ChainOp`] or a [`WarrantOp`].
//!
//! A [`ChainOp`] is a container for a [`Record`], send to a specific type of authority.
