...
mod tests {
    ...
    async fn test_update(
        ...
        let header = HeaderHashed::from_content(update.clone().into());
        (update, header)
    }
    ...
    async fn test_create(
        ...
        let header = HeaderHashed::from_content(create.clone().into());
        (create, header)
    }
    ...
    async fn test_delete(
        ...
        let header = HeaderHashed::from_content(delete.clone().into());
        (delete, header)
    }
