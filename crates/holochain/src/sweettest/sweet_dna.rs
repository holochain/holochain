...
impl SweetDnaFile {
    ...
    pub async fn from_bundle(path: &Path, runtime: DnaRuntime) -> DnaResult<DnaFile> {
        Self::from_bundle_with_overrides(path, DnaModifiersOpt::<SerializedBytes>::none(), runtime)
            .await
    }
