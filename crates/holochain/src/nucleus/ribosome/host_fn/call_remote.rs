...
pub mod wasm_test {
    ...
    use crate::nucleus::ribosome::ZomeCallResponse;
    use crate::{conductor::dna_store::MockDnaStore, nucleus::dna::zome::test_wasm_to_pair};
    use hdk3::prelude::*;
    ...
    async fn call_remote_test() {
        ...
        let dna_def = DnaDef {
            ...
            zomes: vec![test_wasm_to_pair(TestWasm::WhoAmI)].into(),
        };
