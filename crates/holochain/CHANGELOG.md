...
- Update `hcterm` to work with bootstrap2 bootstrap servers. By default, it uses `https://bootstrap2.holochain.org` as the bootstrap2 server. #4767
- Update `hc-service-check` to check bootstrap2 servers. By default, it uses `https://bootstrap2.holochain.org` as the bootstrap2 server. #4767
