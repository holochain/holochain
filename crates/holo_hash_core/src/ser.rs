...
impl<T: HashType> std::convert::TryFrom<&HoloHashImpl<T>> for SerializedBytes {
    type Error = SerializedBytesError;
    fn try_from(t: &HoloHashImpl<T>) -> std::result::Result<SerializedBytes, SerializedBytesError> {
...
impl<T: HashType> std::convert::TryFrom<SerializedBytes> for HoloHashImpl<T> {
    type Error = SerializedBytesError;
    fn try_from(sb: SerializedBytes) -> std::result::Result<HoloHashImpl<T>, SerializedBytesError> {
