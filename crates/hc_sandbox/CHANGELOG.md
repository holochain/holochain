...
- `hc sandbox run` now exits when the conductor(s) failed to spawn. previously it would wait for the user to cancel manually. [#2747](https://github.com/holochain/holochain/pull/2747)
