...
mod tests {
    ...
    macro_rules! newhash {
        ($p:ident, $c:expr) => {
            holo_hash::$p::from_full_bytes([$c as u8; 36].to_vec())
        };
    }
    ...
    async fn test_publish_workflow() {
        ...
        let header_hash = holo_hash::AnyDhtHash::from_full_bytes_and_type(
    ...
    async fn test_get_workflow() {
        ...
        let hash = holo_hash::AnyDhtHash::from_full_bytes_and_type(
            b"eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee".to_vec(),
            holo_hash::hash_type::AnyDht::Header,
        );
    ...
    async fn test_get_links_workflow() {
        ...
        let hash = holo_hash::EntryHash::from_full_bytes_and_type(
            b"eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee".to_vec(),
