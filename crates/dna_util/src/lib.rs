...
pub enum DnaUtilError {
    ...
    /// DnaError
    #[error("DNA error: {0}")]
    DnaError(#[from] monolith::holochain_types::dna::DnaError),
...
/// See `monolith::holochain_types::dna::zome::Zome`.
...
/// See `monolith::holochain_types::dna::DnaDef`.
/// This is a helper to convert to json.
#[derive(Debug, serde::Serialize, serde::Deserialize)]
struct DnaDefJson {
    pub name: String,
...
mod tests {
    ...
    async fn test_extract_then_compile() {
        ...
        let dna_file = monolith::holochain_types::test_utils::fake_dna_zomes(
            "bla",
            vec![
