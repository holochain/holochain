...
pub mod tuning_params_struct {
    ...
    mk_tune! {
        ...
        /// Tx4 max pending send byte count limit.
        /// [Default: 16 MiB]
        tx4_max_send_bytes: u32 = 16 * 1024 * 1024,

        /// Tx4 max pending recv byte count limit.
        /// [Default: 16 MiB]
        tx4_max_recv_bytes: u32 = 16 * 1024 * 1024,

        /// Tx4 max concurrent connection limit.
        /// [Default: 40]
        tx4_max_conn_count: u32 = 40,

        /// Tx4 max init (connect) time for a connection in seconds.
        /// [Default: 20]
        tx4_max_conn_init_s: u32 = 20,
    ...
    impl KitsuneP2pTuningParams {
        ...
        /// Get the tx4_max_conn_init_s param as a Duration.
        pub fn tx4_max_conn_init(&self) -> std::time::Duration {
            std::time::Duration::from_secs(self.tx4_max_conn_init_s as u64)
        }
