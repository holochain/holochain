...
fn test_peer_coverage() {
    ...
    let arc = |c, n, h| {
        let mut arc = DhtArc::from_start_and_halflen(0u32, h);
    ...
    let mut arc = DhtArc::from_start_and_halflen(0u32, MAX_HALF_LENGTH / 2);
    ...
    let mut arc = DhtArc::from_start_and_halflen(0u32, MAX_HALF_LENGTH);
    ...
    let mut arc = DhtArc::from_start_and_halflen(u32::MAX / 2, MAX_HALF_LENGTH);
    ...
    let mut arc = DhtArc::from_start_and_halflen(u32::MAX / 2, 0);
