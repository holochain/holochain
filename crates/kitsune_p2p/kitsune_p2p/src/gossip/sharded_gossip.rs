...
/// Create a recent [`GossipModuleFactory`](crate::gossip::sharded_gossip::GossipModuleFactory)
...
/// Create a [`GossipModuleFactory`](crate::gossip::sharded_gossip::GossipModuleFactory)
