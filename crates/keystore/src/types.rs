...
pub struct SignInput {
    ...
    pub key: holo_hash_ext::AgentPubKey,
...
impl SignInput {
    ...
    pub fn new<D>(key: holo_hash_ext::AgentPubKey, data: D) -> Result<Self, KeystoreError>
    where
    ...
    pub fn new_raw(key: holo_hash_ext::AgentPubKey, data: Vec<u8>) -> Self {
        Self {
            key,
