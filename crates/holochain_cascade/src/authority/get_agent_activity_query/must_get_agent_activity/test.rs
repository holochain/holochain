...
#[test_case(
    ...
    => agent_chain(&[(0, 7..10)]) ; "Until timestamp with lower-bound witness in partial chain")]
#[test_case(
...
#[test_case(
    ...
    ChainFilter::until_timestamp(action_hash(&[9]), Timestamp::from_micros(7000))
    => MustGetAgentActivityResponse::UntilTimestampIndeterminate(Timestamp::from_micros(7000)) ; "Until timestamp missing when lower-bound witness absent")]
