...
- **BREAKING CHANGE**: Renamed macros `hdi_entry_defs` to `hdi_entry_types` and `entry_def` to `entry_type` for naming consistency with `hdk_link_types` [\#2979](https://github.com/holochain/holochain/pull/2979)
