...
impl DhtStore<DbRead<Dht>> {
    ...
    /// [`CounterSigningSessionData`](holochain_zome_types::prelude::CounterSigningSessionData).
    ///
...
/// Build a [`Record`](Record) from a signed
...
/// [`Record`](Record)s (whose `Vec` renders as
