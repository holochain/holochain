...
CREATE TABLE IF NOT EXISTS DhtOp_3up (
    ...
    when_stored          TIMESTAMP     NOT NULL     DEFAULT CURRENT_TIMESTAMP,
...
INSERT INTO DhtOp_3up SELECT * FROM DhtOp;

DROP TABLE DhtOp;

ALTER TABLE DhtOp_3up RENAME TO DhtOp;
