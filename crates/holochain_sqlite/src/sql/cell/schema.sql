...
CREATE TABLE IF NOT EXISTS Header (
  ...
  -- The opaque EntryType
  private_entry INTEGER NULL,
  -- BOOLEAN
  -- Update
  ...
  prev_dna_hash BLOB NULL -- We can't have any of these constraint because
...
CREATE TABLE IF NOT EXISTS DhtOp (
  ...
  when_integrated INTEGER NULL,
  -- DATETIME
  -- We need nanosecond accuracy which doesn't fit in
  -- an INTEGER.
  when_integrated_ns BLOB NULL,
  -- DATETIME
