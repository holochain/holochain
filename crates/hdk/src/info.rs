...
pub fn agent_info() -> ExternResult<AgentInfo> {
    HDK.get().ok_or(WasmError::Guest(HDK_NOT_REGISTERED.to_string()))?.agent_info(())
}

/// @todo Not implemented
pub fn app_info() -> ExternResult<AppInfo> {
    HDK.get().ok_or(WasmError::Guest(HDK_NOT_REGISTERED.to_string()))?.app_info(())
}

/// @todo Not implemented
pub fn dna_info() -> ExternResult<DnaInfo> {
    HDK.get().ok_or(WasmError::Guest(HDK_NOT_REGISTERED.to_string()))?.dna_info(())
}
...
pub fn zome_info() -> ExternResult<ZomeInfo> {
    HDK.get().ok_or(WasmError::Guest(HDK_NOT_REGISTERED.to_string()))?.zome_info(())
}

/// @todo Not implemented
pub fn call_info() -> ExternResult<CallInfo> {
    HDK.get().ok_or(WasmError::Guest(HDK_NOT_REGISTERED.to_string()))?.call_info(())
}
