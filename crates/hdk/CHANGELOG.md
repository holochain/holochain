...
- hdk: link base and target are no longer required to exist on the current DHT and aren't made available via. validation ops (use must_get_entry instead) [#1266](https://github.com/holochain/holochain/pull/1266)
