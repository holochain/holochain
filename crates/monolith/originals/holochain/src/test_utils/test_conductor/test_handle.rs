...
macro_rules! destructure_test_cells {
    ($blob:expr) => {{
        use $crate::holochain::test_utils::itertools::Itertools;
        let blob: $crate::holochain::test_utils::test_conductor::SetupOutput = $blob;
        blob.into_iter()
            .map(|(_, v)| {
                v.into_iter()
                    .collect_tuple()
...
macro_rules! destructure_test_cell_vec {
    ($vec:expr) => {{
        use $crate::holochain::test_utils::itertools::Itertools;
        let vec: Vec<$crate::holochain::test_utils::test_conductor::SetupOutput> = $vec;
        vec.into_iter()
