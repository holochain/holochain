...
use monolith::holochain_zome_types::prelude::EntryDef;
use monolith::holochain_zome_types::prelude::EntryDefsCallbackResult;
use monolith::holochain_zome_types::zome::FunctionName;
use monolith::holochain_zome_types::zome_io::HostFnApiT;
...
mod tests {
    ...
    use monolith::holochain_zome_types::prelude::GetOptions;
