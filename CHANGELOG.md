...
## [holochain\_cli-0.1.0-a-minor-release-test.9](crates/holochain_cli/CHANGELOG.md#0.1.0-a-minor-release-test.9)

This release is just a test for the release workflow. The resulting release on crates.io will be yanked.

# 20221210.033526

## [holochain\_cli-0.1.0-a-minor-release-test.8](crates/holochain_cli/CHANGELOG.md#0.1.0-a-minor-release-test.8)
...
## [holochain\_cli-0.1.0-a-minor-release-test.5](crates/holochain_cli/CHANGELOG.md#0.1.0-a-minor-release-test.5)

This release is just a test for the release workflow. The resulting release on crates.io will be yanked.

## [holochain\_cli\_bundle-0.1.0-a-minor-release-test.0](crates/holochain_cli_bundle/CHANGELOG.md#0.1.0-a-minor-release-test.0)

# 20221210.000031

## [holochain\_cli-0.1.0-a-minor-release-test.4](crates/holochain_cli/CHANGELOG.md#0.1.0-a-minor-release-test.4)

This release is just a test for the release workflow. The resulting release on crates.io will be yanked.

# 20221209.233622

## [holochain\_cli-0.1.0-a-minor-release-test.3](crates/holochain_cli/CHANGELOG.md#0.1.0-a-minor-release-test.3)

## [holochain\_cli\_bundle-0.0.66](crates/holochain_cli_bundle/CHANGELOG.md#0.0.66)

# 20221208.022202

## [holochain\_cli-0.1.0-a-minor-release-test.2](crates/holochain_cli/CHANGELOG.md#0.1.0-a-minor-release-test.2)
